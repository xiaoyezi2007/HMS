<template>
  <div class="patient-home">
    <el-row :gutter="16">
      <el-col v-for="card in cards" :key="card.path" :md="8" :sm="12" :xs="24">
...
import { User, Tickets, CreditCard, View, CollectionTag } from "@element-plus/icons-vue";
...
const cards = [
  ...
  { title: "返回顶部", desc: "点击查看更多功能", path: "/workspace/patient/profile", icon: CollectionTag, bg: "#f3e8ff" }
];
